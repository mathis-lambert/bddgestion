<nav>
    <div class="d-flex column side-nav">
        <div class="d-flex column sn-title">
            <span class="full-size">NEOTICA</span>
            ...
            <ul>
                ...
                if (!empty($_SESSION)) {
                    if (($_SESSION['role'] == 'adherent')) { ?>
                        <!-- ------------ -->
                        <!-- Reservation -->
                        <li><a href="http://bdd.gestion/SAE/pages/reservations.php" id="resa">
                                <div class="d-flex a-tab"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-plus" viewBox="0 0 16 16">

                                        <path d="M8 7a.5.5 0 0 1 .5.5V9H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V10H6a.5.5 0 0 1 0-1h1.5V7.5A.5.5 0 0 1 8 7z" />

                                        <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z" />

                                    </svg> Réservations</div>
                            </a></li>
                        <!-- ------------ -->
                        <!-- Cotisation -->
                        <li><a href="http://bdd.gestion/SAE/pages/paiement-cotisation.php" id="paimcot">
                                <div class="d-flex a-tab"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-currency-euro" viewBox="0 0 16 16">
                    ...
                    <?php } elseif (($_SESSION['role'] == 'admin')) { ?>
                        ...
                        <!-- ------------ -->
                        <!-- Gest Données -->
                        <li><a href='http://bdd.gestion/SAE/pages/gestion-des-donnees.php' id='gestadh'>
                                <div class='d-flex a-tab'>
                        ...
                        <!-- ------------ -->
                        <!-- Gest Cot -->
                        <li><a href='http://bdd.gestion/SAE/pages/gestion-des-cotisations.php' id='gestcots'>
                                <div class='d-flex a-tab'>
                        ...
                        <!-- ------------ -->
                        <!-- Gest resa -->
                        <li><a href='http://bdd.gestion/SAE/pages/gestion-des-reservations.php' id='gestresa'>
                                <div class='d-flex a-tab'>
                    ...
                    <li><a href="http://bdd.gestion/SAE/controllers/connect.php" id="connect">
                            <div class="d-flex a-tab"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                                    <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                                    <path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z" />
                                    <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" />
