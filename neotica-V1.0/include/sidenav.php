<nav>
    <div class="d-flex column side-nav">
        ...
        <div class="sn-items d-grid" multiselectable="true">
            <ul>
                <li><a href="http://localhost/neotica-V1.0/index.php" id="index">
                ...
                if (!empty($_SESSION)) {
                    if (($_SESSION['role'] == 'adherent')) { ?>
                        <!-- ------------ -->
                        <!-- Reservation -->
                        <li><a href="http://localhost/neotica-V1.0/pages/reservations.php" id="resa">
                        ...
                        <!-- ------------ -->
                        <!-- Embarcations -->
                        <li><a href="http://localhost/neotica-V1.0/pages/nos-embarcations.php" id="emb">
                        ...
                        <!-- ------------ -->
                        <!-- Cotisation -->
                        <li><a href="http://localhost/neotica-V1.0/pages/paiement-cotisation.php" id="paimcot">
                    ...
                    <?php } elseif (($_SESSION['role'] == 'admin')) { ?>
                        ...
                        <!-- ------------ -->
                        <!-- Gest Données -->
                        <li><a href='http://localhost/neotica-V1.0/pages/gestion-des-donnees.php' id='gestadh'>
                                <div class='d-flex a-tab'>
                        ...
                        <!-- ------------ -->
                        <!-- Gest Cot -->
                        <li><a href='http://localhost/neotica-V1.0/pages/gestion-des-cotisations.php' id='gestcots'>
                                <div class='d-flex a-tab'>
                        ...
                        <!-- ------------ -->
                        <!-- Gest resa -->
                        <li><a href='http://localhost/neotica-V1.0/pages/gestion-des-reservations.php' id='gestresa'>
                                <div class='d-flex a-tab'>
                    ...
                    <li><a href="http://localhost/neotica-V1.0/controllers/connect.php" id="connect">
            ...
            <div class='d-flex session-info'>
                <div class='session-card'>
                    <div class='d-flex column align-center content profil-card' onclick="profil()">
                        <img src='http://localhost/neotica-V1.0/assets/svg/adherent.svg'>
                        <span><?php echo $_SESSION['prenom']  ?></span>
                        <span> <?php echo $_SESSION['nom']; ?></span>
                    </div>
                    <div class='d-flex logout-button'><a href='http://localhost/neotica-V1.0/logout.php'>
                            <div class='d-flex a-tab justify-center'><img src='http://localhost/neotica-V1.0/assets/svg/logout.svg'></div>
                        </a></div>
                </div>
            </div>
        <?php }
