<nav>
    <div class="d-flex column side-nav">
        ...
        <div class="sn-items d-grid">
            <ul>
                <li><a href="https://neotica.ml-digital.fr/index.php" id="index">
                ...
                if (!empty($_SESSION)) {
                    if (($_SESSION['role'] == 'adherent')) { ?>
                        <!-- ------------ -->
                        <!-- Reservation -->
                        <li><a href="https://neotica.ml-digital.fr/pages/reservations.php" id="resa">
                        ...
                        <!-- ------------ -->
                        <!-- Embarcations -->
                        <li><a href="https://neotica.ml-digital.fr/pages/nos-embarcations.php" id="emb">
                        ...
                        <!-- ------------ -->
                        <!-- Cotisation -->
                        <li><a href="https://neotica.ml-digital.fr/pages/paiement-cotisation.php" id="paimcot">
                    ...
                    <?php } elseif (($_SESSION['role'] == 'admin')) { ?>
                        ...
                        <!-- ------------ -->
                        <!-- Gest Données -->
                        <li><a href='https://neotica.ml-digital.fr/pages/gestion-des-donnees.php' id='gestadh'>
                                <div class='d-flex a-tab'>
                        ...
                        <!-- ------------ -->
                        <!-- Gest Cot -->
                        <li><a href='https://neotica.ml-digital.fr/pages/gestion-des-cotisations.php' id='gestcots'>
                                <div class='d-flex a-tab'>
                        ...
                        <!-- ------------ -->
                        <!-- Gest resa -->
                        <li><a href='https://neotica.ml-digital.fr/pages/gestion-des-reservations.php' id='gestresa'>
                                <div class='d-flex a-tab'>
                    ...
                    <li><a href="https://neotica.ml-digital.fr/controllers/connect.php" id="connect">
            ...
            if ($_SESSION['role'] == 'adherent') { ?>
                ...
                <div class='d-flex session-info'>
                    <div class='session-card'>
                        <div class='content'>
                            <img src='https://neotica.ml-digital.fr/assets/svg/adherent.svg'>
                            <span><?php echo $_SESSION['prenom'] . ' ' . $_SESSION['nom']; ?></span>
                        </div>
                        <div class='logout-button'><a href='https://neotica.ml-digital.fr/logout.php'>
                                <div class='d-flex a-tab justify-center'><img src='https://neotica.ml-digital.fr/assets/svg/logout.svg'></div>
                            </a></div>
                    </div>
                </div>
            ...
            <?php   } elseif ($_SESSION['role'] == 'admin') { ?>
                ...
                <div class='session-info'>
                    <div class='session-card'>
                        ...
                        <div class='d-flex logout-button'><a href='https://neotica.ml-digital.fr/logout.php'>
                                <div class='d-flex a-tab justify-center'><img src='https://neotica.ml-digital.fr/assets/svg/logout.svg'></div>
                            </a></div>
                    </div>
                </div>
